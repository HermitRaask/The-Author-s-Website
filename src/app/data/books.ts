...
export const books: Book[] = [
  ...
  },
  {
    ...
    chapters: [
      ...
      { id: 4, title: "День четвёртый", content: chapterContents["3-4"] },
      { id: 5, title: "День пятый", content: chapterContents["3-5"] },
      { id: 6, title: "День шестой", content: chapterContents["3-6"] },
      { id: 7, title: "День седьмой", content: chapterContents["3-7"] },
      { id: 8, title: "День восьмой", content: chapterContents["3-8"] },
      { id: 9, title: "День девятый", content: chapterContents["3-9"] },
    ],
  },
  {
    id: 4,
    title: "Мир после",
    description: "Я мог бы сказать, что люди живучи, словно тараканы. Но зачем оскорблять насекомых? Впрочем, если отбросить иронию, мы действительно удивительные конформисты. И пусть цивилизация разлетится осколками, а мир обратится пеплом — люди ведь останутся прежними.",
    year: 2023,
    genres: ["Постапакалипсис", "Соцфантастика"],
    workFormat: "Рассказ",
